...
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
//            Uri apkUri = FileProvider.getUriForFile(reactContext, reactContext.getApplicationContext().getPackageName() +".fileprovider", apkFile);//在AndroidManifest中的android:authorities值
//            Log.d("======", "apkUri=" + apkUri);
