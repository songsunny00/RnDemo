/*
 * @Author: badx.龙腾归海 
 * @Date: 2018-07-05 14:54:24 
 * @Last Modified by: badx.龙腾归海
 * @Last Modified time: 2018-07-28 14:49:38
 * @Description: 二维码扫描界面
 */
...
export default class QRScannerView extends Component {
    ...
    _handleBarCodeRead = (e) => {
        if (!this.state.isShowCode) {
            this.setState({
                isShowCode: true
            });
            this.props.onScanResultReceived(e);
        }
    }
        ...
        return (
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                ...
                >
                    {/*绘制顶部标题栏组件*/}
                    {
                        Android ? this.props.renderTopBarView() : null
                    }
                    {/*绘制扫描遮罩*/}
                    <QRScannerRectView
                    ...
                    {/*绘制顶部标题栏组件*/}
                    {
                        iOS ? this.props.renderTopBarView() : null
                    }
